  ...
  return (
    <div className={'pb-12'}>
      <div className={'h-[400px]'}>
        ...
        >
          <SwiperSlide className={'w-full h-full bg-blue-300'}></SwiperSlide>
          <SwiperSlide className={'w-full h-full bg-blue-400'}></SwiperSlide>
        </Swiper>
      </div>
      <div
        className={
          'container m-auto grid grid-cols-1 xl:grid-cols-3 h-full p-3 sm:p-0 gap-3 md:gap-5 mt-6'
        }
      >
        <section className={'col-span-1 md:mt-4 bg-white rounded-xl'}>
          <div
            className={
              'flex items-center justify-between py-4 px-6 dashboard-title rounded-t-xl hover:bg-gray-100 hover:cursor-pointer'
            }
          >
