    ...
    <div className={'container m-auto bg-white p-4 flex flex-col gap-4'}>
      <div className={'flex justify-between items-center py-4'}>
        <div className={'flex items-center gap-4'}>
          <p
            className={'w-[75px] h-[75px] rounded-full border border-basic'}
          ></p>
          <div>
      ...
      <div className={'flex flex-col gap-4 border-basic'}>
        <div
          className={
            'flex flex-col gap-1 text-sm border-basic border rounded-lg p-4 bg-white'
          }
        >
        ...
        <div className={'border-basic border bg-white rounded-lg'}>
          <div className={'min-h-[500px] p-4'}>내용</div>
      ...
      <p className={'flex gap-4'}>
        <button
          className={
            'w-full p-2 bg-blue-500 text-white flex justify-center rounded-lg'
          }
        >
          <svg
            width="24"
        ...
        <button
          className={
            'w-full p-2 bg-red-500 text-white flex justify-center rounded-lg'
          }
        >
          <svg
            width="24"
