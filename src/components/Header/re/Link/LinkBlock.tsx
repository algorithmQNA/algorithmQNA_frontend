...
export default function HeaderLinkBlock(){
    ...
    return(
        <nav
            className={
                'flex justify-between text-lg md:text-xl items-center font-bold gap-2 md:gap-6 whitespace-nowrap col-span-1 w-fit'
            }
        >
            <Link to={'/'} className={'mr-2 md:mr-6'}>
                <span className={'block w-[60px] md:w-[75px] h-auto text-white hover:text-primary transition-colors duration-300'}>
                    <LogoIcon/>
                </span>
            </Link>
